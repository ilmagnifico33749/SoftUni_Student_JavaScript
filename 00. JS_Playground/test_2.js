function solve(examHour, examMinutes, arrivalHour, arrivalMinutes) {
    ...
    3*60 = 180 - 18 = 162 2h42min
        ...
        else if ((examHour > arrivalHour && arrivalMinutes < examMinutes) || (examHour < arrivalHour && arrivalMinutes > examMinutes)) {
            totalDiffMinutes = ((Math.abs(examHour - arrivalHour)) * 60) + Math.abs(arrivalMinutes - examMinutes);
        }
        else if (examHour < arrivalHour && arrivalMinutes > examMinutes) {
            totalDiffMinutes = ((Math.abs(examHour - arrivalHour)) * 60) + Math.abs(arrivalMinutes - examMinutes);
        }
